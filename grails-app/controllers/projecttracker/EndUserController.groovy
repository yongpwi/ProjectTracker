...
class EndUserController {
    ...
    def save(EndUser endUserInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'endUserInstance.label', default: 'EndUser'), endUserInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'endUserInstance.label', default: 'EndUser'), params.id])
                redirect action: "index", method: "GET"
            }
